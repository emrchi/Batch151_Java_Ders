...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getTheNumOfOccurenceOfLetters(s));    //{H=2, e=2, l=2, n=1, o=1, r=1, y=1}


    }

    //Ex1: Verilen bir String'de hangi harfin kac defa kullanildigini veren method olusturunuz.
    //     "Hello Henry" ==> H=2, e=2, l=2, o=1, n=1,r=1,y=1

   public static TreeMap<String,Integer> getTheNumOfOccurenceOfLetters(String s){ //treeMap yaptik cunku harf sirasina gore listelemek istedik.
