...
public class TreeMap01 {
         ...
         /*
            ...
            Eger sirali Map istiyorsak once Hashmap olusturmali daha sonra bu Hashmapten treemap olusturmaliyiz
            asagidaki gibi. Daha hizli olur.
         */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(t2-t1); // 571100
        System.out.println(t3-t2); //69300
